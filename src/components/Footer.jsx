        ...
        <div className="container mx-auto px-4 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-white max-w-xl">
              <h3 className="text-2xl font-bold mb-2">Stay Cool with Our Updates</h3>
            ...
            <div className="w-full md:w-auto">
              <form className="flex gap-2">
                <input
                  ...
                  className="flex-1 md:w-64 px-4 py-3 rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-primary-500"
                />
                <button
                  type="submit"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h2 className="font-bold text-xl">Delhi Air Conditioner</h2>
                <p className="text-sm text-gray-400">Delhi's Trusted AC Experts</p>
              </div>
            </div>
            <p className="text-gray-400">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {services.map((service, index) => (
                ...
                >
                  <MdArrowForward className="mr-2" size={16} />
                  {service.name}
                </Link>
              ))}
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <MdPhone className="text-primary-400 mt-1" size={20} />
                <div>
                  <p className="text-sm text-gray-400">24/7 Emergency</p>
                  <a href="tel:+919773754227" className="text-white hover:text-primary-400 transition-colors">
                    +91-97737 54227
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                <MdEmail className="text-primary-400 mt-1" size={20} />
                <div>
                  <p className="text-sm text-gray-400">Email Us</p>
                  <a href="mailto:info@delhiairconditioner.com" className="text-white hover:text-primary-400 transition-colors">
              ...
              <div className="flex items-start space-x-3">
                <MdLocationPin className="text-primary-400 mt-1" size={20} />
                <div>
              ...
              <div className="flex items-start space-x-3">
                <MdAccessTime className="text-primary-400 mt-1" size={20} />
                <div>
                  <p className="text-sm text-gray-400">Business Hours</p>
                  <p className="text-white">Monday - Sunday: 9:00 AM - 8:00 PM</p>
                </div>
              </div>
            </div>
          </div>
